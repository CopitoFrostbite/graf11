...
public:
	...
	SkyDome(HWND hWnd, OpenGLClass* OpenGL, int stacks, int slices, float radio, const wchar_t* textmorning, const wchar_t* textafternoon, const wchar_t* textnight, const wchar_t* textamanecer, int nummorning, int numafter, int numnight, int numamanecer)
	{
		this->hWnd = hWnd;
		sale = OpenGL;
		...
		EnvioTexturasCielo(OpenGL, textmorning, nummorning);
		EnvioTexturasCielo(OpenGL, textafternoon, numafter);
		EnvioTexturasCielo(OpenGL, textnight, numnight);
		EnvioTexturasCielo(OpenGL, textamanecer, numamanecer);
	...
	void EnvioTexturasCielo(OpenGLClass* OpenGL, const wchar_t* textura, int numtext) {
